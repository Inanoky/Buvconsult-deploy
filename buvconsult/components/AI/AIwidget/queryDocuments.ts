...
export async function talkToDocuments(){
...
const prompt = "What are the conditions for returning retention money back for the contractor?"
// Usage:
const results = await queryDocuments(prompt)
