...
const featureCopy = {
  ...
  ru: {
    eyebrow: "Практичные системы, измеримая ценность",
    title: "Проекты для команд, которые строят и производят",
    items: [
      {
        name: "AI-автоматизация процессов",
        description:
          "Автоматизируйте извлечение данных из документов, отчеты, согласования и повторяющиеся координационные задачи с контролируемыми AI-процессами.",
        icon: Bot,
      },
      {
        name: "Строительное ПО",
        description:
          "Создавайте записи проектов, журналы объекта, потоки счетов, архивы доказательств и панели, которые соответствуют реальной работе на объекте.",
        icon: HardHat,
      },
      {
        name: "Инструменты для производства",
        description:
          "Создавайте производственные журналы, системы контроля качества, складские инструменты и управленческие представления для заводских команд.",
        icon: Factory,
      },
      {
        name: "Операционная аналитика",
        description:
          "Превращайте сообщения, PDF, таблицы, фото и системные данные в панели, по которым команда может действовать.",
        icon: ChartNoAxesCombined,
      },
    ],
  },
