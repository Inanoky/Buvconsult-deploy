...
export type LandingLocale = "lv" | "en" | "ru";
...
export const landingCopy = {
  ...
  ru: {
    badge: "Бесплатная консультация и интерактивный макет",
    header: "AI и цифровой партнер для строительства",
    header2: "",
    description:
      "Мы создаем индивидуальное ПО и AI-решения, которые автоматизируют администрирование, согласования, отчетность и повторяющиеся строительные процессы.",
    supporting:
      "Каждое решение подстраивается под то, как ваша компания уже работает, без необходимости менять привычные процессы команды.",
    audienceLabel: "Решения для строительных команд",
    audienceItems: ["Генподрядчики", "Специализированные подрядчики"],
    proof:
      "Без крупных первоначальных вложений. Оплата начинается только после принятия решения.",
    primaryCta: "Записаться на бесплатную консультацию",
    secondaryCta: "Посмотреть возможности",
    visualTitle: "Строительный рабочий процесс",
    visualMessage: "Процесс проанализирован. Макет готов.",
    visualInput: "Счета, учет времени, BIS, WhatsApp",
    visualOutput: "Индивидуальный инструмент для вашей команды",
    visualSteps: [
      { label: "Обсуждение", text: "Процесс и требования" },
      { label: "Макет", text: "Интерактивный просмотр решения" },
      { label: "Тестирование", text: "Проверка с вашей командой" },
      { label: "Запуск", text: "Рабочее решение в эксплуатации" },
    ],
    visualStatusLabel: "Статус",
    visualDevelopmentLabel: "Срок разработки",
    visualDevelopmentValue: "2 недели",
    visualNextActionLabel: "Следующий шаг",
    buildTitle: "Что мы можем создать",
    buildIntro: "Мы помогаем строительным компаниям автоматизировать и цифровизировать операционные процессы.",
    buildItems: [
      "Процессы согласования счетов",
      "Управление персоналом и учет времени",
      ...
      "Внутренние процессы согласования",
      "Индивидуальные панели и отчеты",
      "Любой уникальный процесс вашего бизнеса",
    ],
    workTitle: "Как это работает",
    workHeadline: "От первой встречи до принятого решения.",
    workItems: [
      {
        title: "Расскажите о задаче",
        desc: "Назовите процесс, который занимает слишком много времени, создает ошибки или раздражает команду.",
      },
      {
        title: "Бесплатная консультация",
        desc: "Забронируйте встречу и просто объясните, как процесс работает сейчас.",
      },
      {
        title: "Решение и макет",
        desc: "Мы анализируем рабочий процесс и бесплатно готовим предложение вместе с интерактивным макетом. Также предложим идеи автоматизации и AI для дальнейшего улучшения процесса.",
      },
      {
        title: "Разработка",
        desc: "После подтверждения начинаем разработку и регулярно информируем о прогрессе.",
      },
      {
        title: "Тестирование",
        desc: "Система тестируется внутри вашей организации и дорабатывается по отзывам реальных пользователей.",
      },
      {
        title: "Запуск",
        desc: "Мы запускаем систему только тогда, когда вы довольны результатом. Оплата начинается после принятия решения.",
      },
    ],
    pricingTitle: "Цены",
    pricingHeadline: "Разработка бесплатна и включена в ежемесячную стоимость.",
    pricingIntro: "Консультация, анализ процесса и интерактивные макеты всегда бесплатны.",
    pricingItems: [
      {
        title: "Простой процесс",
        price: "€200/месяц",
        meta: "До 15 пользователей",
        desc: "Подходит для небольших внутренних процессов и автоматизации.",
      },
      {
        title: "Средняя сложность",
        price: "€400/месяц",
        meta: "До 40 пользователей",
        desc: "Подходит для более крупных процессов с несколькими пользователями и интеграциями.",
      },
      {
        title: "Сложные решения",
        price: "Индивидуальное предложение",
        meta: "Системы корпоративного уровня",
        desc: "Для AI-решений, сложных интеграций и систем уровня предприятия.",
      },
    ],
    whyTitle: "Почему Buvconsult?",
    whyHeadline: "Премиальный специалист, а не обычная software-студия.",
    whyParagraphs: [
      "В отличие от традиционных software-агентств, мы понимаем строительство. Наша команда объединяет опытных разработчиков и строительных специалистов, которые знают, как планируются, ведутся и сдаются проекты.",
      "Мы не просто строим то, что попросили. Мы анализируем существующий процесс, находим возможности автоматизации, ставим под сомнение неэффективные шаги и проектируем ПО, которое действительно экономит время и улучшает прозрачность операций.",
      "Наша цель проста: создать ПО, которое окупает себя за счет повышения эффективности вашего бизнеса.",
    ],
    existingTitle: "Почему не купить готовое ПО?",
    existingHeadline: "ПО должно адаптироваться к вашему бизнесу.",
    existingIntro: "Большинство программ заставляет бизнес подстраиваться под систему. Мы создаем ПО, которое подстраивается под ваш бизнес.",
    existingItems: [
      "Без лишних функций",
      "Без сложного внедрения",
      "Без изменения привычной работы команды",
      "Создано под ваши процессы",
      "Легко расширяется по мере роста бизнеса",
    ],
  },
} as const;
