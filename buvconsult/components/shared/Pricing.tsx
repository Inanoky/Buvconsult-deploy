...
import {CreateSubscription} from "@/server/actions/shared-actions";
    ...
    return (
        ...
        <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className = "mt-2 text-4xl font-bold tracking-tight sm:text-4xl">
                Pricing plans for everyone and every budget ! </h1>



        </div>
            <p className="mx-auto mt-6 max-w-2xl text-center leading-tight text-muted-foreground"> Lorem ipsum dolor sit amet,
                consectetur adipisicing elit.
                Cum ea facilis nam repellat. Asperiores
                assumenda ducimus iusto, laudantium molestiae, molestias
                officiis perferendis praesentium quam quasi quis
                saepe tempore, vel voluptate! </p>
