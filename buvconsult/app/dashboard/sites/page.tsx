    ...
    return(
        ...
        <div className="flex w-full justify-end">
            ...
            border-dashed p-8 text-center animate-in fade-in-50">
                ...
                <p className="mb-8 mt-2 text-center test-small leading-tight text-muted-foreground max-w-sm mx-auto">You currently don't have any Projects. Please create some so that you can see them right here!</p>
           <Button asChild>
                <Link href={"/dashboard/sites/new"}>
                    <PlusCircle className="mr-2 size-4"/>
                    Create Project
