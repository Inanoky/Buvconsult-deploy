...
import { Config, configSchema, explanationsSchema, Result } from "@/lib/VercelChat/lib/types";
...
export const runGenerateSQLQuery = async (query: string) => {
  ...
  let data: any;
  try {
    data = await prisma.$queryRawUnsafe(query); // Use $queryRawUnsafe to allow dynamic input
  } catch (e: any) {
